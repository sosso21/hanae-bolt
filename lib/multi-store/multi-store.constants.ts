...
export const STORES: Store[] = [
  ...
  },
  {
    ...
    STORE_KIND: "REAL",
    NEXT_SHOPIFY_ACCESS_TOKEN:
      process.env.NEXT_OUT_STREET_SHOPIFY_ACCESS_TOKEN ?? "",
    NEXT_SHOPIFY_API_KEY: process.env.NEXT_OUT_STREET_SHOPIFY_API_KEY ?? "",
    NEXT_SHOPIFY_SECRET_KEY:
      process.env.NEXT_OUT_STREET_SHOPIFY_SECRET_KEY ?? "",
    NEXT_SHOPIFY_STORE_DOMAIN:
      process.env.NEXT_OUT_STREET_SHOPIFY_STORE_DOMAIN ?? "",
  },
];
