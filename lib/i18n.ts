...
export const translations = {
  fr: {
    ...
    services: {
      ...
      technologiesAndTools: "Technologies & Outils",
      technologiesWeMaster: "Les technologies que nous maîtrisons",
      platformsTitle: "Plateformes publicitaires",
      includedServicesTitle: "Services inclus",
      ourFeaturesTitle: "Nos prestations :",
  ...
  en: {
    ...
    services: {
      ...
      development: {
        ...
        description:
          "Creation of web, desktop and mobile applications with the latest technologies. Design and maintenance of backends, APIs and databases.",
        features: [
          "Custom Web Applications",
          "Mobile Applications (iOS/Android)",
          "Desktop Applications",
          "Robust APIs and Backends",
          "Optimized Databases",
          "Software Engineer Delegation",
        ],
      },
      design: {
        title: "Design & Multimedia",
        description:
          "Creation of strong visual identities, professional video editing and creative animations to enhance your brand.",
        features: [
      ...
      marketing: {
        title: "Marketing & Communication",
        description:
          "Complete digital marketing strategies, social media management and viral content creation to boost your visibility.",
        features: [
          "Community management",
          "Sponsored advertising (Meta, Google, TikTok)",
      ...
      administration: {
        ...
        description:
          "Complete handling of your administrative procedures and formalities, for individuals and professionals. Accounting included for a turnkey service.",
        features: [
          "Complete administrative procedure management",
          "Obtaining and renewing official documents",
          "Filing and tracking of files",
          "Business creation support",
          "Task outsourcing",
          "Simplified accounting management",
        ],
        services: [
          "Document requests and renewals",
          "Administrative file filing",
  ...
  ar: {
    ...
    services: {
      ...
      discoverAll: "اكتشف جميع خدماتنا",
      keyPoints: "النقاط الرئيسية:",
      technologies: "التقنيات:",
      technologiesAndTools: "التقنيات والأدوات",
      technologiesWeMaster: "التقنيات التي نتقنها",
      platformsTitle: "منصات الإعلانات",
      includedServicesTitle: "الخدمات المدرجة",
      ourFeaturesTitle: "خدماتنا:",
      technologyCategories: {
      ...
      development: {
        ...
        description:
          "إنشاء تطبيقات الويب وسطح المكتب والجوال بأحدث التقنيات. تصميم وصيانة الخوادم وواجهات برمجة التطبيقات وقواعد البيانات.",
        features: [
          "تطبيقات الويب المخصصة",
          "تطبيقات الجوال (iOS/Android)",
          "تطبيقات سطح المكتب",
          "واجهات برمجة التطبيقات والخوادم القوية",
          "قواعد البيانات المحسّنة",
          "تفويض مهندسي البرمجيات",
        ],
      },
      design: {
        title: "التصميم والوسائط المتعددة",
        description:
          "إنشاء هويات بصرية قوية، تحرير فيديو احترافي ورسوم متحركة إبداعية لتعزيز علامتك التجارية.",
        features: [
          "إنشاء الشعارات والهوية البصرية",
      ...
      marketing: {
        ...
        description:
          "استراتيجيات التسويق الرقمي الشاملة، إدارة وسائل التواصل الاجتماعي وإنشاء محتوى فيروسي لتعزيز ظهورك.",
        features: [
          "إدارة المجتمع",
          "الإعلانات الممولة (Meta، Google، TikTok)",
          "إنشاء محتوى فيروسي",
      ...
      administration: {
        ...
        description:
          "معالجة كاملة لإجراءاتك وإجراءاتك الإدارية، للأفراد والمهنيين. المحاسبة مشمولة لخدمة جاهزة للاستخدام.",
        features: [
          "إدارة الإجراءات الإدارية الكاملة",
          "الحصول على الوثائق الرسمية وتجديدها",
          "إيداع ومتابعة الملفات",
          "دعم إنشاء الأعمال",
          "الاستعانة بمصادر خارجية للمهام",
          "إدارة محاسبية مبسطة",
        ],
        services: [
          "طلبات وتجديدات الوثائق",
          "إيداع الملفات الإدارية",
          "إدارة المحاسبة",
          "الإقرارات الضريبية",
