...
export const translations = {
  fr: {
    ...
    hero: {
      title: 'Votre partenaire digital multi-services',
      subtitle: 'Développement, Design, Marketing & Gestion d\'entreprise',
      description: 'Nous transformons vos idées en solutions digitales performantes avec notre expertise dans 4 domaines clés.',
    ...
    services: {
      ...
      development: {
        ...
        description: 'Applications web, mobile et desktop avec les dernières technologies'
      },
      design: {
    ...
    footer: {
      description: 'Agence web multi-services spécialisée en développement, design, marketing digital et gestion d\'entreprise.',
  ...
  en: {
    ...
    hero: {
      title: 'Your multi-service digital partner',
      subtitle: 'Development, Design, Marketing & Business Management',
      description: 'We transform your ideas into high-performance digital solutions with our expertise in 4 key areas.',
    ...
    services: {
      ...
      development: {
        ...
        description: 'Web, mobile and desktop applications with the latest technologies'
      },
      design: {
    ...
    footer: {
      description: 'Multi-service web agency specialized in development, design, digital marketing and business management.',
  ...
  ar: {
    ...
    hero: {
      title: 'شريكك الرقمي متعدد الخدمات',
      subtitle: 'التطوير، التصميم، التسويق وإدارة الأعمال',
      description: 'نحول أفكارك إلى حلول رقمية عالية الأداء بخبرتنا في 4 مجالات رئيسية.',
      cta: 'اكتشف خدماتنا',
      contact: 'تواصل معنا'
    },
    services: {
    ...
    footer: {
      description: 'وكالة ويب متعددة الخدمات متخصصة في التطوير والتصميم والتسويق الرقمي وإدارة الأعمال.',
