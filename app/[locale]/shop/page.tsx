...
import { PRODUCTS, PRODUCT_CATEGORIES, getFeaturedProducts } from "@/constants/products";
...
export async function generateMetadata({
  ...
  return {
    ...
    description: "Découvrez nos services, formations et templates pour booster votre présence digitale.",
    alternates: {
...
export default async function ShopPage({ params }: PageProps) {
  ...
  const shopSubtitle = "Services, formations et outils pour développer votre activité";
              ...
              <div className="flex sm:flex-row flex-col justify-center gap-4 mb-8">
                <div className="relative flex-1 max-w-md">
                  ...
                  <input
                    ...
                    className="border-input bg-background px-10 py-2 border rounded-md w-full text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                  />
                </div>
              ...
              {PRODUCTS.map((product) => (
                ...
                >
                  ...
                  <CardContent className="p-4">
                    <h3 className="mb-2 font-semibold text-sm leading-tight line-clamp-2">
                      {product.name}
                    </h3>
