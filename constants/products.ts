...
export const PRODUCTS: Product[] = [
  {
    ...
    description: "Site web professionnel responsive avec design moderne, optimisé SEO et prêt pour mobile. Parfait pour présenter votre entreprise.",
    price: 899,
    originalPrice: 1299,
  ...
  },
  {
    ...
    description: "Boutique en ligne complète avec gestion des produits, paiements sécurisés, tableau de bord admin et intégration logistique.",
    price: 2499,
    originalPrice: 3499,
  ...
  },
  {
    ...
    description: "Formation complète pour maîtriser React et Next.js. De débutant à expert avec projets pratiques et certification.",
    price: 599,
  ...
  },
  {
    ...
    description: "Template de tableau de bord administrateur moderne avec composants réutilisables, thème sombre/clair et responsive.",
    price: 149,
    originalPrice: 199,
  ...
  },
  {
    ...
    description: "Analyse approfondie de votre site web avec recommandations détaillées pour améliorer votre référencement naturel.",
    price: 299,
  ...
  },
  {
    ...
    description: "Création d'une identité visuelle unique : logo, charte graphique, cartes de visite, et supports de communication.",
    price: 799,
    originalPrice: 999,
